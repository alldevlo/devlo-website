...
export const SERVICE_PAGE_DATA: Record<ServiceSlug, ServicePageData> = {
  "outbound-multicanal": {
    ...
    pageTitle: "Agence Outbound B2B Suisse : Cold Email, LinkedIn et Calling",
    pageSubtitle: "Cold email + LinkedIn + calling coordonnés pour générer des rendez-vous qualifiés avec les bons décideurs.",
    metadataTitle: "Agence Outbound B2B Suisse : multicanal",
    metadataDescription:
      "Agence outbound B2B suisse pour prospection omnicanale : cold email, LinkedIn, calling et rendez-vous qualifiés.",
    metadataKeywords: [
    ...
    heroParagraphs: [
      "En tant qu'agence outbound B2B en Suisse, devlo contacte vos comptes prioritaires via plusieurs canaux coordonnés : cold email personnalisé, messages LinkedIn, appels ciblés et relances synchronisées. Nous concevons et exécutons ces campagnes de A à Z, de la définition de l'ICP à la qualification des réponses et à la prise de rendez-vous directement dans l'agenda de votre équipe commerciale.",
    ...
    editorialTitle: "Pourquoi choisir une agence outbound multicanal plutôt qu'un canal isolé ?",
    editorialParagraphs: [
  ...
  "generation-leads": {
    ...
    metadataKeywords: [
      ...
      "génération de prospects B2B suisse",
      "construction ICP",
      "TAM SAM ICP",
    ...
    heroParagraphs: [
      "Pour devlo, agence de lead generation B2B en Suisse, la génération de prospects ne consiste pas à acheter une base de contacts. Elle consiste à déterminer quelles entreprises peuvent réellement devenir clientes, quels décideurs doivent être approchés, et quel signal rend le timing commercial pertinent.",
    ...
    editorialTitle: "Comment une agence de lead generation construit-elle un pipeline avant la séquence ?",
    editorialParagraphs: [
  ...
  "prise-de-rendez-vous": {
    ...
    pageTitle: "Prise de Rendez-Vous B2B Suisse : rendez-vous qualifiés et gestion inbox",
    ...
    metadataKeywords: [
      ...
      "rendez-vous qualifiés B2B suisse",
      "booking qualifié",
      "gestion inbox prospection",
      "appointment setting",
    ],
    heroParagraphs: [
      "La prise de rendez-vous B2B est le point critique entre prospection et revenu. Un prospect intéressé peut être perdu si la réponse tarde, si la qualification est trop légère, ou si le suivi est insuffisant. devlo transforme cet intérêt en rendez-vous qualifiés B2B exploitables par votre équipe commerciale.",
    ...
    editorialTitle: "Comment transformer une réponse en rendez-vous B2B réellement utile ?",
    editorialParagraphs: [
